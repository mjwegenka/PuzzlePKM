...
export const objectColors: Record<ColorableType, ObjectColorToken> = {
  'daily-note':   { text: '#7dbad6', bg: 'rgba(26,138,181,0.18)',  border: 'rgba(26,138,181,0.45)',  accent: '#1a8ab5' },
  'topic-note':   { text: '#7dcfaa', bg: 'rgba(72,178,120,0.18)',  border: 'rgba(72,178,120,0.45)',  accent: '#48b278' },
