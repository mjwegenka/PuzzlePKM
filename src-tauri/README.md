...
- Command bridge: Tauri command `run_puzzlepkm_cli`
...
- Interactive shell mode (`puzzlepkm` with no args or `puzzlepkm shell`) is not embedded in the current command panel.
